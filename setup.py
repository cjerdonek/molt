...
def _convert_md_to_rst(path):
    target_path = convert_md_to_rst(path, __file__)
...
"""
    ...
    readme_path = _convert_md_to_rst(README_PATH)
    history_path = _convert_md_to_rst(HISTORY_PATH)

    sections = [intro, read(readme_path), read(history_path)]
